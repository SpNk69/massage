...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """pagrindinis""", """controllers.HomeController.pagrindinis"""),
  ...
  // @LINE:16
  private[this] lazy val controllers_HomeController_pagrindinis4_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("pagrindinis")))
  )
  private[this] lazy val controllers_HomeController_pagrindinis4_invoker = createInvoker(
    HomeController_0.pagrindinis,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "pagrindinis",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:16
    case controllers_HomeController_pagrindinis4_route(params) =>
      call { 
        controllers_HomeController_pagrindinis4_invoker.call(HomeController_0.pagrindinis)
      }
