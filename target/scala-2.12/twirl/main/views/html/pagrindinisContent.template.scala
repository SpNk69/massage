    ...
    <div id="kontaktai" class="text-center">
        <div class="row">
            <div class="col-lg-12 price-section2">
                ...
                <p><strong><i class="fa fa-phone"></i> Telefono numeris</strong><br>
                    +41 797897010</p>
                <p>
