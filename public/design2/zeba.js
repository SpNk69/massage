        ...
        getMassagesTitles: function () {
            return {
                "lt": {
                    ...
                    "relaxFoot": "Atpalaiduojantis pėdų masažas",
                ...
                "de": {
                    ...
                    "relaxFoot": "Entspannende Fussmassage",
                    "sepHead":"Kopfmassage",
                ...
                "ru": {
                    ...
                    "relaxFoot": "Расслабляющий массаж стоп",
        ...
        getMassageBodyData: function(){
            return {
                "lt":{
                    ...
                    "relaxFoot": "Taikomas pavargusioms, skausmingoms pėdoms atpalaiduoti, kūno gyvybiniam tonusui padidinti, imunitetui stiprinti. Ši procedūra tinka daug vaikštantiems, dirbantiems stovimą arba žmonėms šąlančiomis kojomis. Pėdų masažas padeda atsigauti ir pailsėti visam organizmui.",
                ...
                "de":{
                    ...
                    "relaxFoot": "Gebrauchte müde Füsse zu entspannen, erhöhen Vitalität, Verbesserung der Immunität. Dieses Verfahren eignet sich für viele Menschen, die stehen oder eine Menge Leute auch, die einen kalten Fusse haben. Massage der Füsse hilft, den ganzen Körper wiederherzustellen und zu atmen.",
                ...
                "ru":{
                    ...
                    "relaxFoot": "Используется для расслабления усталых стоп, увеличения жизненого тонуса, повышения иммунитета. Эта процедура подходит для многих людей, которые работают стоя или много ходитб также людей у которых мёрзнит стопы. Массаж стоп помогает восстановить и одохнуть всему телу.",
        ...
        getPrices: function () {
            return {
                "lt": {
                    ...
                    "limphoBody": ["Limfodrenažinis kūno masažas", "-","140","180"],
                    "limphoFace": ["Limfodrenažinis veido masažas","100","-","-"],
                    "stoneHotCold": ["Karštų-šaltų akmenų masažas","-","170","220"],
                    ...
                    // "antice": ["Anticeliulitinis masažas rankomis"],
                    "relaxFoot": ["Atpalaiduojantis pėdų masažas","100","-","-"],
                    "anticel":["Anticeliulitiniai masažai su Tibeto taure","30min","60min","90min"],
                ...
                "de": {
                    ...
                    "limphoBody": ["Manuelle Lymphdrainage", "-","140","180"],
                    "limphoFace": ["Manuelle Lymphdrainage Gesicht","100","-","-"],
                    "stoneHotCold": ["Heiß-kalt Steinmassage","-","170","220"],
                    ...
                    // "antice": ["Anti-Cellulite massage"],
                    "relaxFoot": ["Entspannende Fussmassage","100","-","-"],
                    "anticel":["Anti-Cellulite Handmassage Mit Tibetische Lehm Cup:","30min","60min","90min"],
                ...
                "ru": {
                    ...
                    "limphoBody": ["Лимфодренажный массаж тела", "-","140","180"],
                    "limphoFace": ["Лимфодренажный массаж лица","100","-","-"],
                    "stoneHotCold": ["Горячих - холодных камней массаж","-","170","220"],
                    ...
                    // "antice": ["Антицеллюлитный массаж"],
                    "relaxFoot": ["Расслабляющий массаж стоп","100","-","-"],
                    "anticel":["Антицеллюлитный ручной массаж ","30min","60min","90min"],
